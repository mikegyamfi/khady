...
class CustomUser(AbstractUser):
    ...
    unique_shipping_code = models.CharField(max_length=100, null=True, blank=True)
...
class ShippingOrder(models.Model):
    ...
    estimated_date_of_arrival = models.DateTimeField(null=True, blank=True)
...
class Package(models.Model):
    ...
    cbm = models.DecimalField(max_digits=10, decimal_places=1,  null=True, blank=True)
